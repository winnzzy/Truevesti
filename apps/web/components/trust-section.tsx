...
const TRUST_ITEMS = [
  {
    ...
    description: "Multi-layered encryption and security protocols protect your assets around the clock."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "All accounts undergo identity verification to maintain platform integrity and compliance."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Cold storage and multi-signature wallets ensure maximum fund safety."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Continuous platform monitoring and real-time threat detection systems."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Dedicated support team available across time zones for investor assistance."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Enterprise-grade risk management frameworks to protect investor capital."
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-5">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-gray-400 max-w-2xl mx-auto">
            Enterprise-grade infrastructure designed to protect your investments and personal data.
          </p>
        </div>
          ...
          {TRUST_ITEMS.map((item, i) => (
            ...
            >
              ...
              <div className="relative">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 group-hover:bg-emerald-500/20 transition-colors">
                  {item.icon}
                </div>
